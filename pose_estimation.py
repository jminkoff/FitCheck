# -*- coding: utf-8 -*-
"""
Created on Mon Mar 20 14:59:27 2023
...
img_path = "path/to/image" #image_1.jpg"  ./input/ ... / ...
...
def get_keypoints_per_person(all_keypoints, all_scores, confs, keypoint_threshold=2, conf_threshold=0.9):
    keypoints_list = []
    # iterate for every person detected
    for person_id in range(len(all_keypoints)):
        # check the confidence score of the detected person
        if confs[person_id] > conf_threshold:
            ...
            keypoints_list.append(keypoints_person)
...
keypoints_list = get_keypoints_per_person(output["keypoints"], output["keypoints_scores"], output["scores"])
